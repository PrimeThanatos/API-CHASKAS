...
namespace API_CHASKAS.Infrastructure.Persistance.PaymentMethodRepository
{
    public class PaymentMethodRepository: IPaymentMethodRepository
    {
        public async Task<List<PaymentMethod>> Up_GetPaymentMethods()
        {
            ...
            {
                new PaymentMethod { PK = 1, Name = "PaymentMethod 1" },
                new PaymentMethod { PK = 2, Name = "PaymentMethod 2" },
        ...
        public async Task<PaymentMethod> Up_GetPaymentMethodByPK(int paymentMethodPK)
        {
            ...
            PaymentMethod paymentMethod = new PaymentMethod { PK = paymentMethodPK, Name = "PaymentMethod " + paymentMethodPK };
        ...
        public async Task<InsertGenericResult> InsertPaymentMethod(PaymentMethod paymentMethod)
        {
            ...
            InsertGenericResult result = new InsertGenericResult { Message = "Método de pago insertado correctamente", Pk = 987 }; // Se asume un valor de clave primaria ficticio (987)
