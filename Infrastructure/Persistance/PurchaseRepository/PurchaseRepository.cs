...
namespace API_CHASKAS.Infrastructure.Persistance.PurchaseRepository
{
    public class PurchaseRepository: IPurchaseRepository
    {
        public async Task<List<Purchase>> Up_GetPurchases()
        {
            ...
            {
                new Purchase { Id = 1, FKPurchaseInvoce = 101, FKProduct = 1, Measure = "Units", Quantity = 5, SubTotal = 50.0m, Taxes = 5.0m, Total = 55.0m },
                new Purchase { Id = 2, FKPurchaseInvoce = 102, FKProduct = 2, Measure = "Kg", Quantity = 2.5m, SubTotal = 30.0m, Taxes = 3.0m, Total = 33.0m },
        ...
        public async Task<Purchase> Up_GetPurchaseById(int purchaseId)
        {
            // Simulación de obtener una compra por su clave primaria
            Purchase purchase = new Purchase { Id = purchaseId, FKPurchaseInvoce = 103, FKProduct = 3, Measure = "Liters", Quantity = 8, SubTotal = 80.0m, Taxes = 8.0m, Total = 88.0m };
        ...
        public async Task<InsertGenericResult> InsertPurchase(Purchase purchase)
        {
            ...
            InsertGenericResult result = new InsertGenericResult { Message = "Compra insertada correctamente", Id = 456 }; // Se asume un valor de clave primaria ficticio (456)
