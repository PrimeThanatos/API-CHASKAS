...
namespace API_CHASKAS.Infrastructure.Persistance.CustomerRepository
{
    public class CustomerRepository: ICustomerRepository
    {
        public async Task<List<Customer>> Up_GetCustomers()
        {
            ...
            {
                new Customer { PK = 1, Name = "Customer 1", Description = "Description 1", Tel = "123456789", Email = "customer1@example.com", Address = "Address 1", Available = true },
                new Customer { PK = 2, Name = "Customer 2", Description = "Description 2", Tel = "987654321", Email = "customer2@example.com", Address = "Address 2", Available = true },
        ...
        public async Task<Customer> Up_GetCustomerByPK(int customerPK)
        {
            // Simulación de obtener un cliente por su clave primaria
            Customer customer = new Customer { PK = customerPK, Name = "Customer " + customerPK, Description = "Description " + customerPK, Tel = "555555555", Email = "customer" + customerPK + "@example.com", Address = "Address " + customerPK, Available = true };
        ...
        public async Task<InsertGenericResult> InsertCustomer(Customer customer)
        {
            ...
            InsertGenericResult result = new InsertGenericResult { Message = "Cliente insertado correctamente", Pk = 789 }; // Se asume un valor de clave primaria ficticio (789)
