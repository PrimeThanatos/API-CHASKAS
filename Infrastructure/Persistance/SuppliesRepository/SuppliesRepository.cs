...
namespace API_CHASKAS.Infrastructure.Persistance.SuppliesRepository
{
    public class SuppliesRepository : ISuppliesRepository
    {
        public async Task<List<Supplier>> Up_GetSuppliers()
        {
            ...
            {
                new Supplier { PK = 1, Name = "SupplierA", Description = "Supplier A Description", RFC = "RFC123", CP = "12345", Adress = "Address1", CreditDays = 30, Available = true },
                new Supplier { PK = 2, Name = "SupplierB", Description = "Supplier B Description", RFC = "RFC456", CP = "67890", Adress = "Address2", CreditDays = 45, Available = true },
        ...
        public async Task<Supplier> Up_GetSupplierByPK(int SupplierPK)
        {
            ...
            Supplier supplier = new Supplier { PK = SupplierPK, Name = "SupplierC", Description = "Supplier C Description", RFC = "RFC789", CP = "54321", Adress = "Address3", CreditDays = 60, Available = true };
        ...
        public async Task<InsertGenericResult> InsertSupplier(Supplier Supplier)
        {
            ...
            InsertGenericResult result = new InsertGenericResult { Message = "Proveedor insertado correctamente", Pk = 987 }; // Se asume un valor de clave primaria ficticio (987)
